...
%D:\\workspace\\project\\trunk\\bld\\out\\model_analysis\\logs\\reg.log
%
...
class WriteProjectPathsPython(Task.Task):
    ...
    **Example**::
        ...
        PROJECT_PATHS['OUT_FINAL'] = 'bld/out/output'

    leads to::

        project_paths['OUT_FINAL'] = "/abs/path/to/your_project/bld/out/output"

    or::

        project_paths['OUT_FINAL'] = "C:\\your_project\\bld\\out\\output"
...
class WriteProjectPathsR(Task.Task):
    ...
    **Example**::
    ...
    leads to::
        ...
        PATH_OUT_FINAL <<- '/path/to/your_project/bld/out/output'

    or::

        PATH_OUT_FINAL <<- 'C:\your_project\bld\out\output'
...
class WriteProjectPathsPerl(Task.Task):
    ...
    **Example**::
    ...
    leads to::
        ...
        $project_paths{'OUT_FINAL'} = '/path/to/your_project/bld/out/output';

    or::

        $project_paths{'PATH_OUT_FINAL'} = 'C:\your_project\bld\out\output';
...
class WriteProjectPathsStata(Task.Task):
    ...
    **Example**::
        ...
        PROJECT_PATHS['OUT_FINAL'] = 'out/output'

    leads to:

    .. code-block:: none

        global PATH_OUT_FINAL = "/path/to/your_project/bld/out/output"

    or:

    .. code-block:: none

        global PATH_OUT_FINAL = "C:\your_project\out\output"
