...
functions of your compile_datasets_bls.py waf script as shown in the example below:
...
perform a source code model_analysis on all C/C++ build tasks that have been
...
The result of the source code model_analysis will be stored both as xml and html
...
<html>
	...
	<body class="body">
		...
		<div id="page">
			...
			<div id="footer">
				<div>cppcheck - a tool for static C/C++ code model_analysis</div>
				<div>
