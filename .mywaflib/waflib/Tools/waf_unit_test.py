...
The tests are declared by adding the **test** feature to programs::
	...
	def build(bld):
		bld(features='cxx cxxprogram test', source='compile_datasets_bls.py.cpp', target='app')
		# or
...
the predefined callback::
	...
	def build(bld):
		bld(features='cxx cxxprogram test', source='compile_datasets_bls.py.c', target='app')
