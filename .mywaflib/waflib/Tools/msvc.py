...
or::
	...
	def build(bld):
		tg = bld.program(source='compile_datasets_bls.py.c', target='app', use='KERNEL32 USER32 GDI32')
...
def apply_flags_msvc(self):
	...
	Add additional flags implied by msvc, such as subsystems and pdb files::
		...
		def build(bld):
			bld.stlib(source='compile_datasets_bls.py.c', target='bar', subsystem='gruik')
	"""
