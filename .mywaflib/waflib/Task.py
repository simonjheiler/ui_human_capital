...
class Task(evil):
	...
	def signature(self):
		...
		made to the input nodes (not to the outputs!). The signature hashes original_data from various sources:
		...
		* hashed original_data: variables/values read from task.vars/task.env :py:meth:`waflib.Task.Task.sig_vars`
...
def compile_fun(line, shell=False):
	...
	* The list of variables that must cause rebuilds when *env* original_data is modified
