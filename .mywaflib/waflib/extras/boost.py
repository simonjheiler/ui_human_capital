...
When using this tool, the wscript will look like:
	...
	def build(bld):
		bld(source='compile_datasets_bls.py.cpp', target='app', use='BOOST')
...
int compile_datasets_bls.py() { std::cout << BOOST_LIB_VERSION << ":" << BOOST_VERSION << std::endl; }
'''

BOOST_ERROR_CODE = '''
#include <boost/system/error_code.hpp>
int compile_datasets_bls.py() { boost::system::error_code c; }
'''

PTHREAD_CODE = '''
#include <pthread.h>
static void* f(void*) { return 0; }
int compile_datasets_bls.py() {
	pthread_t th;
	pthread_attr_t attr;
...
int compile_datasets_bls.py() { boost::thread t; }
'''
