...
def waf_entry_point(current_directory, version, wafdir):
	"""
	This is the compile_datasets_bls.py entry point, all Waf execution starts here.
...
def set_main_module(file_path):
	"""
	Read the compile_datasets_bls.py wscript file into :py:const:`waflib.Context.Context.g_module` and
...
def distclean(ctx):
	'''removes build folders and original_data'''
...
class Dist(Context.Context):
	...
	def get_base_name(self):
		"""
		Returns the default name of the compile_datasets_bls.py directory in the archive, which is set to *appname-version*.
