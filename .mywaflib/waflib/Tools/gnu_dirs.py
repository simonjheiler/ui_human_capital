...
SHAREDSTATEDIR architecture-independent variable original_data    PREFIX/com
LOCALSTATEDIR  variable original_data                             PREFIX/var
LIBDIR         object code libraries                     EXEC_PREFIX/lib
INCLUDEDIR     header files                              PREFIX/include
OLDINCLUDEDIR  header files for non-GCC compilers        /usr/include
DATAROOTDIR    architecture-independent original_data root        PREFIX/share
DATADIR        architecture-independent original_data             DATAROOTDIR
INFODIR        GNU "info" documentation                  DATAROOTDIR/info
LOCALEDIR      locale-dependent original_data                     DATAROOTDIR/locale
